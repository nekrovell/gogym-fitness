...
const PAIN = [
	{
		t: 'Спор на входе',
		d: 'Клиент уверен, что осталось четыре посещения, администратор видит два. Правым обычно оказывается тот, кто громче'
	},
	{
		t: 'Поменять цену — целое дело',
		d: 'Поднять стоимость абонемента или завести новый вид зачастую нельзя без человека, который настраивал программу'
	},
	{
		t: 'Тетрадь на стойке',
		d: 'Кто пришёл, кто заплатил, кому пора продлевать — всё держится на памяти администратора'
	},
	{
		...
		>
			<div className="grid gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)] lg:gap-20">
				<SectionHead
					...
					lead="Пока клуб маленький, всё держится на людях. На двухстах клиентах это начинает стоить денег."
				/>
